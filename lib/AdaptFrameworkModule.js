...
import AdaptCli from './AdaptCli';
import AdaptFrameworkBuild from './AdaptFrameworkBuild';
import fs from 'fs-extra';
import FWUtils from './AdaptFrameworkUtils';
    ...
    if(shouldUpdate) {
      ...
      if(installed) {
        if(semver.gte(installed, compatible)) {
          return this.log('debug', `valid local adapt_framework found (${installed}), skipping install`);
        } else {
