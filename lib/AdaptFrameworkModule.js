    ...
    this.apiRouter.addRoute(
      {
        ...
        meta: ApiDef.routeMetadata.preview
      },
      {
        route: '/publish/:id',
        handlers: { post: FWUtils.postHandler, get: FWUtils.getHandler },
        meta: ApiDef.routeMetadata.publish
      },
      {
        route: '/import',
        handlers: { post: [FWUtils.importHandler] },
        meta: ApiDef.routeMetadata.import
      },
      {
        route: '/export/:id',
        handlers: { post: FWUtils.postHandler, get: FWUtils.getHandler },
        meta: ApiDef.routeMetadata.export
      }
    );
